...
const Requests: FC = () => {
  ...
  if (isLoading) return <div className="flex justify-center items-center h-screen text-black">Loading...</div>;
  if (error || fetchError) return <div className="flex justify-center items-center h-screen text-red-500">{error?.message || fetchError}</div>;
